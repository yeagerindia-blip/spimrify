...
function Withdrawal() {
    ...
    return (
        <div style={{ padding: "20px", color: "white", backgroundColor: "#1a1a1a", minHeight: "100vh" }}>
            <h2>Virtual 🪙 coins cannot be withdrawn, exchanged for cash, or converted into real money.</h2>
            ...
            <form onSubmit={handleWithdraw}>
                ...
                <p style={{ textAlign: "center", marginBottom: "9px" }}>🪙 Spimrify Coins are virtual only and cannot be withdrawn or converted into real money.</p>
